...
1	#ffffff	t	#ffffff	CLOUD4DEV	2024-03-13 12:17:50.785	2024-06-11 17:16:49.301	2024-03-13 12:17:53.406	1	1	#F28705	#ffffff	NOUS CONTACTER	/contact	#
\.
...
25	plugin_upload_metrics	{"weeklySchedule":"55 9 16 * * 3","lastWeeklyUpdate":1740568378042}	object	\N	\N
...
2	Public	Default role given to unauthenticated user.	public	2024-02-23 12:43:13.166	2024-06-04 15:36:02.304	\N	\N
\.
...
SELECT pg_catalog.setval('public.components_c4d_components_accordions_components_id_seq', 136, true);
...
SELECT pg_catalog.setval('public.components_c4d_components_accordions_id_seq', 2, true);
...
SELECT pg_catalog.setval('public.components_c4d_components_ellipses_id_seq', 11, true);
...
SELECT pg_catalog.setval('public.components_c4d_components_vertical_spaces_id_seq', 13, true);
...
SELECT pg_catalog.setval('public.components_c4d_items_accordions_items_id_seq', 6, true);
...
SELECT pg_catalog.setval('public.files_related_morphs_id_seq', 1475, true);
...
SELECT pg_catalog.setval('public.menus_components_id_seq', 12, true);
...
SELECT pg_catalog.setval('public.pages_components_id_seq', 62, true);
...
SELECT pg_catalog.setval('public.up_permissions_id_seq', 101, true);
...
SELECT pg_catalog.setval('public.up_permissions_role_links_id_seq', 101, true);
